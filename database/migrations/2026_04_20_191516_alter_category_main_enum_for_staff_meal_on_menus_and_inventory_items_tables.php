...
return new class extends Migration
{
    ...
    {
        if (Schema::getConnection()->getDriverName() === 'mysql') {
            DB::statement("ALTER TABLE inventory_items MODIFY COLUMN category_main ENUM('food','alcohol','beverage','cigarette','breakage','room','LD') NULL");
            DB::statement("ALTER TABLE menus MODIFY COLUMN category_main ENUM('food','alcohol','beverage','cigarette','breakage','room','LD') NULL");
