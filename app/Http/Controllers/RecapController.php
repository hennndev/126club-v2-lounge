...
class RecapController extends Controller
{
    ...
    private function buildLiveRecapExportRows(array $recapData): array
    {
        $rows = [
            ...
            ['Total Food (Qty)', (float) ($recapData['dashboardPreview']['total_food'] ?? 0)],
            ['Total Alcohol (Qty)', (float) ($recapData['dashboardPreview']['total_alcohol'] ?? 0)],
            ['Total Beverage (Qty)', (float) ($recapData['dashboardPreview']['total_beverage'] ?? 0)],
            ['Total Cigarette (Qty)', (float) ($recapData['dashboardPreview']['total_cigarette'] ?? 0)],
            ['Total Breakage (Qty)', (float) ($recapData['dashboardPreview']['total_breakage'] ?? 0)],
            ['Total Room (Qty)', (float) ($recapData['dashboardPreview']['total_room'] ?? 0)],
            ['Total LD (Qty)', (float) ($recapData['dashboardPreview']['total_ld'] ?? 0)],
    ...
    private function buildHistoryExportRows(RecapHistory $recapHistory): array
    {
        return [
            ...
            ['Total Food (Qty)', (float) ($recapHistory->total_food ?? 0)],
            ['Total Alcohol (Qty)', (float) ($recapHistory->total_alcohol ?? 0)],
            ['Total Beverage (Qty)', (float) ($recapHistory->total_beverage ?? 0)],
            ['Total Cigarette (Qty)', (float) ($recapHistory->total_cigarette ?? 0)],
            ['Total Breakage (Qty)', (float) ($recapHistory->total_breakage ?? 0)],
            ['Total Room (Qty)', (float) ($recapHistory->total_room ?? 0)],
            ['Total LD (Qty)', (float) ($recapHistory->total_ld ?? 0)],
